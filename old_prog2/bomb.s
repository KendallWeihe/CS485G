...
0000000000400e4d <main>:
  ...
  400e6f:	be c4 25 40 00       	mov    $0x4025c4,%esi
  ...
  400e8c:	be c6 25 40 00       	mov    $0x4025c6,%esi
  ...
  400ea8:	be e3 25 40 00       	mov    $0x4025e3,%esi
  ...
  400f0d:	bf fd 25 40 00       	mov    $0x4025fd,%edi
...
0000000000400ff7 <phase_3>:
  ...
  40100a:	be 66 27 40 00       	mov    $0x402766,%esi
...
0000000000401144 <func4>:
  ...
  40115a:	7e 0c                	jle    401168 <func4+0x24>
  ...
  40117d:	48 83 c4 08          	add    $0x8,%rsp
  401181:	c3                   	retq   

0000000000401182 <phase_4>:
  401182:	48 83 ec 18          	sub    $0x18,%rsp
  401186:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx
  40118b:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx
  401190:	be 4d 2a 40 00       	mov    $0x402a4d,%esi
  401195:	b8 00 00 00 00       	mov    $0x0,%eax
  40119a:	e8 11 fb ff ff       	callq  400cb0 <__isoc99_sscanf@plt>
  40119f:	83 f8 02             	cmp    $0x2,%eax
  4011a2:	75 07                	jne    4011ab <phase_4+0x29>
  4011a4:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)
  4011a9:	76 05                	jbe    4011b0 <phase_4+0x2e>
  4011ab:	e8 8c 05 00 00       	callq  40173c <explode_bomb>
  4011b0:	ba 0e 00 00 00       	mov    $0xe,%edx
  4011b5:	be 00 00 00 00       	mov    $0x0,%esi
  4011ba:	8b 7c 24 08          	mov    0x8(%rsp),%edi
  4011be:	e8 81 ff ff ff       	callq  401144 <func4>
  4011c3:	83 f8 07             	cmp    $0x7,%eax
  4011c6:	75 07                	jne    4011cf <phase_4+0x4d>
  4011c8:	83 7c 24 0c 07       	cmpl   $0x7,0xc(%rsp)
  4011cd:	74 05                	je     4011d4 <phase_4+0x52>
  4011cf:	e8 68 05 00 00       	callq  40173c <explode_bomb>
  4011d4:	48 83 c4 18          	add    $0x18,%rsp
  4011d8:	c3                   	retq   

00000000004011d9 <phase_5>:
  4011d9:	48 83 ec 18          	sub    $0x18,%rsp
  4011dd:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx
  4011e2:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx
  4011e7:	be 4d 2a 40 00       	mov    $0x402a4d,%esi
  4011ec:	b8 00 00 00 00       	mov    $0x0,%eax
  4011f1:	e8 ba fa ff ff       	callq  400cb0 <__isoc99_sscanf@plt>
  4011f6:	83 f8 01             	cmp    $0x1,%eax
  4011f9:	7f 05                	jg     401200 <phase_5+0x27>
  4011fb:	e8 3c 05 00 00       	callq  40173c <explode_bomb>
  401200:	8b 44 24 08          	mov    0x8(%rsp),%eax
  401204:	83 e0 0f             	and    $0xf,%eax
  401207:	89 44 24 08          	mov    %eax,0x8(%rsp)
  40120b:	83 f8 0f             	cmp    $0xf,%eax
  40120e:	74 2c                	je     40123c <phase_5+0x63>
  401210:	b9 00 00 00 00       	mov    $0x0,%ecx
  401215:	ba 00 00 00 00       	mov    $0x0,%edx
  40121a:	83 c2 01             	add    $0x1,%edx
  40121d:	48 98                	cltq   
  40121f:	8b 04 85 c0 27 40 00 	mov    0x4027c0(,%rax,4),%eax
  401226:	01 c1                	add    %eax,%ecx
  401228:	83 f8 0f             	cmp    $0xf,%eax
  40122b:	75 ed                	jne    40121a <phase_5+0x41>
  40122d:	89 44 24 08          	mov    %eax,0x8(%rsp)
  401231:	83 fa 0f             	cmp    $0xf,%edx
  401234:	75 06                	jne    40123c <phase_5+0x63>
  401236:	3b 4c 24 0c          	cmp    0xc(%rsp),%ecx
  40123a:	74 05                	je     401241 <phase_5+0x68>
  40123c:	e8 fb 04 00 00       	callq  40173c <explode_bomb>
  401241:	48 83 c4 18          	add    $0x18,%rsp
  401245:	c3                   	retq   

0000000000401246 <phase_6>:
  401246:	41 55                	push   %r13
  401248:	41 54                	push   %r12
  40124a:	55                   	push   %rbp
  40124b:	53                   	push   %rbx
  40124c:	48 83 ec 58          	sub    $0x58,%rsp
  401250:	48 89 e6             	mov    %rsp,%rsi
  401253:	e8 1a 05 00 00       	callq  401772 <read_six_numbers>
  401258:	49 89 e5             	mov    %rsp,%r13
  40125b:	41 bc 00 00 00 00    	mov    $0x0,%r12d
  401261:	4c 89 ed             	mov    %r13,%rbp
  401264:	41 8b 45 00          	mov    0x0(%r13),%eax
  401268:	83 e8 01             	sub    $0x1,%eax
  40126b:	83 f8 05             	cmp    $0x5,%eax
  40126e:	76 05                	jbe    401275 <phase_6+0x2f>
  401270:	e8 c7 04 00 00       	callq  40173c <explode_bomb>
  401275:	41 83 c4 01          	add    $0x1,%r12d
  401279:	41 83 fc 06          	cmp    $0x6,%r12d
  40127d:	75 07                	jne    401286 <phase_6+0x40>
  40127f:	be 00 00 00 00       	mov    $0x0,%esi
  401284:	eb 42                	jmp    4012c8 <phase_6+0x82>
  401286:	44 89 e3             	mov    %r12d,%ebx
  401289:	48 63 c3             	movslq %ebx,%rax
  40128c:	8b 04 84             	mov    (%rsp,%rax,4),%eax
  40128f:	39 45 00             	cmp    %eax,0x0(%rbp)
  401292:	75 05                	jne    401299 <phase_6+0x53>
  401294:	e8 a3 04 00 00       	callq  40173c <explode_bomb>
  401299:	83 c3 01             	add    $0x1,%ebx
  40129c:	83 fb 05             	cmp    $0x5,%ebx
  40129f:	7e e8                	jle    401289 <phase_6+0x43>
  4012a1:	49 83 c5 04          	add    $0x4,%r13
  4012a5:	eb ba                	jmp    401261 <phase_6+0x1b>
  4012a7:	48 8b 52 08          	mov    0x8(%rdx),%rdx
  4012ab:	83 c0 01             	add    $0x1,%eax
  4012ae:	39 c8                	cmp    %ecx,%eax
  4012b0:	75 f5                	jne    4012a7 <phase_6+0x61>
  4012b2:	eb 05                	jmp    4012b9 <phase_6+0x73>
  4012b4:	ba 20 43 60 00       	mov    $0x604320,%edx
  4012b9:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)
  4012be:	48 83 c6 04          	add    $0x4,%rsi
  4012c2:	48 83 fe 18          	cmp    $0x18,%rsi
  4012c6:	74 14                	je     4012dc <phase_6+0x96>
  4012c8:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx
  4012cb:	83 f9 01             	cmp    $0x1,%ecx
  4012ce:	7e e4                	jle    4012b4 <phase_6+0x6e>
  4012d0:	b8 01 00 00 00       	mov    $0x1,%eax
  4012d5:	ba 20 43 60 00       	mov    $0x604320,%edx
  4012da:	eb cb                	jmp    4012a7 <phase_6+0x61>
  4012dc:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx
  4012e1:	48 8d 44 24 28       	lea    0x28(%rsp),%rax
  4012e6:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi
  4012eb:	48 89 d9             	mov    %rbx,%rcx
  4012ee:	48 8b 10             	mov    (%rax),%rdx
  4012f1:	48 89 51 08          	mov    %rdx,0x8(%rcx)
  4012f5:	48 83 c0 08          	add    $0x8,%rax
  4012f9:	48 39 f0             	cmp    %rsi,%rax
  4012fc:	74 05                	je     401303 <phase_6+0xbd>
  4012fe:	48 89 d1             	mov    %rdx,%rcx
  401301:	eb eb                	jmp    4012ee <phase_6+0xa8>
  401303:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)
  40130a:	00 
  40130b:	bd 05 00 00 00       	mov    $0x5,%ebp
  401310:	48 8b 43 08          	mov    0x8(%rbx),%rax
  401314:	8b 00                	mov    (%rax),%eax
  401316:	39 03                	cmp    %eax,(%rbx)
  401318:	7d 05                	jge    40131f <phase_6+0xd9>
  40131a:	e8 1d 04 00 00       	callq  40173c <explode_bomb>
  40131f:	48 8b 5b 08          	mov    0x8(%rbx),%rbx
  401323:	83 ed 01             	sub    $0x1,%ebp
  401326:	75 e8                	jne    401310 <phase_6+0xca>
  401328:	48 83 c4 58          	add    $0x58,%rsp
  40132c:	5b                   	pop    %rbx
  40132d:	5d                   	pop    %rbp
  40132e:	41 5c                	pop    %r12
  401330:	41 5d                	pop    %r13
  401332:	c3                   	retq   

0000000000401333 <fun7>:
  401333:	48 83 ec 08          	sub    $0x8,%rsp
  401337:	48 85 ff             	test   %rdi,%rdi
  40133a:	74 2b                	je     401367 <fun7+0x34>
  40133c:	8b 17                	mov    (%rdi),%edx
  40133e:	39 f2                	cmp    %esi,%edx
  401340:	7e 0d                	jle    40134f <fun7+0x1c>
  401342:	48 8b 7f 08          	mov    0x8(%rdi),%rdi
  401346:	e8 e8 ff ff ff       	callq  401333 <fun7>
  40134b:	01 c0                	add    %eax,%eax
  40134d:	eb 1d                	jmp    40136c <fun7+0x39>
  40134f:	b8 00 00 00 00       	mov    $0x0,%eax
  401354:	39 f2                	cmp    %esi,%edx
  401356:	74 14                	je     40136c <fun7+0x39>
  401358:	48 8b 7f 10          	mov    0x10(%rdi),%rdi
  40135c:	e8 d2 ff ff ff       	callq  401333 <fun7>
  401361:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax
  401365:	eb 05                	jmp    40136c <fun7+0x39>
  401367:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  40136c:	48 83 c4 08          	add    $0x8,%rsp
  401370:	c3                   	retq   

0000000000401371 <secret_phase>:
  401371:	53                   	push   %rbx
  401372:	e8 3d 04 00 00       	callq  4017b4 <read_line>
  401377:	ba 0a 00 00 00       	mov    $0xa,%edx
  40137c:	be 00 00 00 00       	mov    $0x0,%esi
  401381:	48 89 c7             	mov    %rax,%rdi
  401384:	e8 07 f9 ff ff       	callq  400c90 <strtol@plt>
  401389:	48 89 c3             	mov    %rax,%rbx
  40138c:	8d 40 ff             	lea    -0x1(%rax),%eax
  40138f:	3d e8 03 00 00       	cmp    $0x3e8,%eax
  401394:	76 05                	jbe    40139b <secret_phase+0x2a>
  401396:	e8 a1 03 00 00       	callq  40173c <explode_bomb>
  40139b:	89 de                	mov    %ebx,%esi
  40139d:	bf 40 41 60 00       	mov    $0x604140,%edi
  4013a2:	e8 8c ff ff ff       	callq  401333 <fun7>
  4013a7:	83 f8 07             	cmp    $0x7,%eax
  4013aa:	74 05                	je     4013b1 <secret_phase+0x40>
  4013ac:	e8 8b 03 00 00       	callq  40173c <explode_bomb>
  4013b1:	bf 40 27 40 00       	mov    $0x402740,%edi
  4013b6:	e8 05 f8 ff ff       	callq  400bc0 <puts@plt>
  4013bb:	e8 1a 05 00 00       	callq  4018da <phase_defused>
  4013c0:	5b                   	pop    %rbx
  4013c1:	c3                   	retq   
  4013c2:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
  4013c9:	00 00 00 
  4013cc:	0f 1f 40 00          	nopl   0x0(%rax)

00000000004013d0 <sig_handler>:
  4013d0:	48 83 ec 08          	sub    $0x8,%rsp
  4013d4:	bf 00 28 40 00       	mov    $0x402800,%edi
  4013d9:	e8 e2 f7 ff ff       	callq  400bc0 <puts@plt>
  4013de:	bf 03 00 00 00       	mov    $0x3,%edi
  4013e3:	e8 38 f9 ff ff       	callq  400d20 <sleep@plt>
  4013e8:	be c9 29 40 00       	mov    $0x4029c9,%esi
  4013ed:	bf 01 00 00 00       	mov    $0x1,%edi
  4013f2:	b8 00 00 00 00       	mov    $0x0,%eax
  4013f7:	e8 c4 f8 ff ff       	callq  400cc0 <__printf_chk@plt>
  4013fc:	48 8b 3d 9d 37 20 00 	mov    0x20379d(%rip),%rdi        # 604ba0 <__TMC_END__>
  ...
  401412:	bf d1 29 40 00       	mov    $0x4029d1,%edi
...
0000000000401426 <invalid_phase>:
  ...
  40142d:	be d9 29 40 00       	mov    $0x4029d9,%esi
...
00000000004014d2 <initialize_bomb>:
  ...
  401520:	bf 38 28 40 00       	mov    $0x402838,%edi
  ...
  401554:	be ea 29 40 00       	mov    $0x4029ea,%esi
  ...
  401572:	bf 70 28 40 00       	mov    $0x402870,%edi
...
00000000004015f4 <skip>:
  4015f4:	53                   	push   %rbx
  4015f5:	48 63 05 c0 35 20 00 	movslq 0x2035c0(%rip),%rax        # 604bbc <num_input_strings>
  4015fc:	48 8d 3c 80          	lea    (%rax,%rax,4),%rdi
  401600:	48 c1 e7 04          	shl    $0x4,%rdi
  401604:	48 81 c7 e0 4b 60 00 	add    $0x604be0,%rdi
  40160b:	48 8b 15 ae 35 20 00 	mov    0x2035ae(%rip),%rdx        # 604bc0 <infile>
...
0000000000401635 <send_msg>:
  ...
  401652:	8b 35 64 35 20 00    	mov    0x203564(%rip),%esi        # 604bbc <num_input_strings>
  401658:	8d 46 ff             	lea    -0x1(%rsi),%eax
  40165b:	48 98                	cltq   
  40165d:	4c 8d 04 80          	lea    (%rax,%rax,4),%r8
  401661:	49 c1 e0 04          	shl    $0x4,%r8
  401665:	49 81 c0 e0 4b 60 00 	add    $0x604be0,%r8
  ...
  40168d:	be a8 28 40 00       	mov    $0x4028a8,%esi
  ...
  4016a9:	b8 04 2a 40 00       	mov    $0x402a04,%eax
  4016ae:	41 b9 0c 2a 40 00    	mov    $0x402a0c,%r9d
  ...
  4016c7:	b9 15 2a 40 00       	mov    $0x402a15,%ecx
...
0000000000401772 <read_six_numbers>:
  ...
  401796:	be 41 2a 40 00       	mov    $0x402a41,%esi
...
00000000004017b4 <read_line>:
  ...
  4017c7:	48 8b 05 da 33 20 00 	mov    0x2033da(%rip),%rax        # 604ba8 <stdin@@GLIBC_2.2.5>
  4017ce:	48 39 05 eb 33 20 00 	cmp    %rax,0x2033eb(%rip)        # 604bc0 <infile>
  4017d5:	75 14                	jne    4017eb <read_line+0x37>
  4017d7:	bf 53 2a 40 00       	mov    $0x402a53,%edi
  4017dc:	e8 df f3 ff ff       	callq  400bc0 <puts@plt>
  4017e1:	bf 08 00 00 00       	mov    $0x8,%edi
  4017e6:	e8 05 f5 ff ff       	callq  400cf0 <exit@plt>
  4017eb:	bf 71 2a 40 00       	mov    $0x402a71,%edi
  ...
  401804:	48 8b 05 9d 33 20 00 	mov    0x20339d(%rip),%rax        # 604ba8 <stdin@@GLIBC_2.2.5>
  40180b:	48 89 05 ae 33 20 00 	mov    %rax,0x2033ae(%rip)        # 604bc0 <infile>
  ...
  40186a:	bf 7c 2a 40 00       	mov    $0x402a7c,%edi
  40186f:	e8 4c f3 ff ff       	callq  400bc0 <puts@plt>
  401874:	8b 05 42 33 20 00    	mov    0x203342(%rip),%eax        # 604bbc <num_input_strings>
  40187a:	8d 50 01             	lea    0x1(%rax),%edx
  40187d:	89 15 39 33 20 00    	mov    %edx,0x203339(%rip)        # 604bbc <num_input_strings>
  401883:	48 98                	cltq   
  401885:	48 6b c0 50          	imul   $0x50,%rax,%rax
  401889:	48 bf 2a 2a 2a 74 72 	movabs $0x636e7572742a2a2a,%rdi
  401890:	75 6e 63 
  401893:	48 89 b8 e0 4b 60 00 	mov    %rdi,0x604be0(%rax)
  40189a:	48 bf 61 74 65 64 2a 	movabs $0x2a2a2a64657461,%rdi
  4018a1:	2a 2a 00 
  4018a4:	48 89 b8 e8 4b 60 00 	mov    %rdi,0x604be8(%rax)
  ...
  4018c1:	c6 84 01 e0 4b 60 00 	movb   $0x0,0x604be0(%rcx,%rax,1)
  4018c8:	00 
  4018c9:	83 c2 01             	add    $0x1,%edx
  4018cc:	89 15 ea 32 20 00    	mov    %edx,0x2032ea(%rip)        # 604bbc <num_input_strings>
...
00000000004018da <phase_defused>:
  ...
  4018f8:	83 3d bd 32 20 00 06 	cmpl   $0x6,0x2032bd(%rip)        # 604bbc <num_input_strings>
  ...
  401910:	be 97 2a 40 00       	mov    $0x402a97,%esi
  401915:	bf d0 4c 60 00       	mov    $0x604cd0,%edi
  ...
  401929:	be a0 2a 40 00       	mov    $0x402aa0,%esi
  ...
  40193c:	bf f8 28 40 00       	mov    $0x4028f8,%edi
  401941:	e8 7a f2 ff ff       	callq  400bc0 <puts@plt>
  401946:	bf 20 29 40 00       	mov    $0x402920,%edi
  40194b:	e8 70 f2 ff ff       	callq  400bc0 <puts@plt>
  401950:	b8 00 00 00 00       	mov    $0x0,%eax
  401955:	e8 17 fa ff ff       	callq  401371 <secret_phase>
  40195a:	bf 58 29 40 00       	mov    $0x402958,%edi
  40195f:	e8 5c f2 ff ff       	callq  400bc0 <puts@plt>
  401964:	bf 88 29 40 00       	mov    $0x402988,%edi
...
0000000000401990 <sigalrm_handler>:
  ...
  401999:	ba b0 31 40 00       	mov    $0x4031b0,%edx
  40199e:	be 01 00 00 00       	mov    $0x1,%esi
  4019a3:	48 8b 3d 06 32 20 00 	mov    0x203206(%rip),%rdi        # 604bb0 <stderr@@GLIBC_2.2.5>
...
0000000000401adc <submitr>:
  ...
  401e1f:	b9 80 32 40 00       	mov    $0x403280,%ecx
  ...
  401fcf:	00 
  401fd0:	be 87 32 40 00       	mov    $0x403287,%esi
  ...
  401ffd:	00 
  401ffe:	b9 d8 31 40 00       	mov    $0x4031d8,%ecx
  ...
  4021d9:	b9 08 32 40 00       	mov    $0x403208,%ecx
...
00000000004022f2 <init_driver>:
  ...
  4023a1:	bf f9 2c 40 00       	mov    $0x402cf9,%edi
  ...
  402449:	66 c7 44 24 02 3b 14 	movw   $0x143b,0x2(%rsp)
  ...
  402463:	41 b8 f9 2c 40 00    	mov    $0x402cf9,%r8d
  402469:	b9 58 32 40 00       	mov    $0x403258,%ecx
...
00000000004024c7 <driver_post>:
  ...
  4024d6:	be 98 32 40 00       	mov    $0x403298,%esi
  ...
  40250b:	41 b8 af 32 40 00    	mov    $0x4032af,%r8d
  402511:	48 89 f9             	mov    %rdi,%rcx
  402514:	ba bb 32 40 00       	mov    $0x4032bb,%edx
  402519:	be 14 3b 00 00       	mov    $0x3b14,%esi
  40251e:	bf f9 2c 40 00       	mov    $0x402cf9,%edi
...
0000000000402540 <__libc_csu_init>:
  ...
  4025a4:	c3                   	retq   
  4025a5:	66 66 2e 0f 1f 84 00 	data32 nopw %cs:0x0(%rax,%rax,1)
  4025ac:	00 00 00 00 
