...
000000000040103a <initialize_target>:
  ...
  401165:	be 60 30 40 00       	mov    $0x403060,%esi
...
00000000004011dc <main>:
  ...
  401220:	be 0a 20 40 00       	mov    $0x40200a,%esi
  ...
  401239:	bd 6a 31 40 00       	mov    $0x40316a,%ebp
  40123e:	eb 05                	jmp    401245 <main+0x69>
  401240:	bd 65 31 40 00       	mov    $0x403165,%ebp
  ...
  401272:	ff 24 c5 b0 31 40 00 	jmpq   *0x4031b0(,%rax,8)
  401279:	48 8b 3b             	mov    (%rbx),%rdi
  40127c:	e8 2f fd ff ff       	callq  400fb0 <usage>
  401281:	be 15 34 40 00       	mov    $0x403415,%esi
  ...
  4012a9:	ba 72 31 40 00       	mov    $0x403172,%edx
  ...
  40130e:	be 8f 31 40 00       	mov    $0x40318f,%esi
  ...
  401364:	be c8 30 40 00       	mov    $0x4030c8,%esi
  ...
  40137d:	e8 29 08 00 00       	callq  401bab <check_fail>
  401382:	8b 15 9c 41 20 00    	mov    0x20419c(%rip),%edx        # 605524 <cookie>
  401388:	be a2 31 40 00       	mov    $0x4031a2,%esi
  ...
  4013a3:	e8 62 0d 00 00       	callq  40210a <stable_launch>
...
000000000040198c <touch2>:
  ...
  4019a4:	be 90 32 40 00       	mov    $0x403290,%esi
  ...
  4019bd:	e8 74 04 00 00       	callq  401e36 <validate>
  4019c2:	eb 1e                	jmp    4019e2 <touch2+0x56>
  4019c4:	be b8 32 40 00       	mov    $0x4032b8,%esi
  ...
  4019dd:	e8 16 05 00 00       	callq  401ef8 <fail>
...
00000000004019ec <hexmatch>:
  ...
  401a46:	b9 87 32 40 00       	mov    $0x403287,%ecx
...
0000000000401a9a <touch3>:
  ...
  401abd:	be e0 32 40 00       	mov    $0x4032e0,%esi
  ...
  401ad6:	e8 5b 03 00 00       	callq  401e36 <validate>
  401adb:	eb 21                	jmp    401afe <touch3+0x64>
  401add:	48 89 da             	mov    %rbx,%rdx
  401ae0:	be 08 33 40 00       	mov    $0x403308,%esi
  ...
  401af9:	e8 fa 03 00 00       	callq  401ef8 <fail>
...
0000000000401b08 <test>:
  ...
  401b18:	be 30 33 40 00       	mov    $0x403330,%esi
...
0000000000401b40 <save_char>:
  ...
  401b58:	0f b6 b1 50 36 40 00 	movzbl 0x403650(%rcx),%esi
  ...
  401b6f:	0f b6 b7 50 36 40 00 	movzbl 0x403650(%rdi),%esi
...
0000000000401bab <check_fail>:
  ...
  401bc2:	be 53 33 40 00       	mov    $0x403353,%esi
...
0000000000401c32 <notify_server>:
  ...
  401c6c:	be 88 34 40 00       	mov    $0x403488,%esi
  ...
  401cab:	41 b9 69 33 40 00    	mov    $0x403369,%r9d
  401cb1:	eb 06                	jmp    401cb9 <notify_server+0x87>
  401cb3:	41 b9 6e 33 40 00    	mov    $0x40336e,%r9d
  ...
  401cd4:	b9 73 33 40 00       	mov    $0x403373,%ecx
  ...
  401d3b:	00 
  401d3c:	be 8f 33 40 00       	mov    $0x40338f,%esi
  ...
  401d89:	ba 69 33 40 00       	mov    $0x403369,%edx
  401d8e:	66 90                	xchg   %ax,%ax
  401d90:	eb 05                	jmp    401d97 <notify_server+0x165>
  401d92:	ba 6e 33 40 00       	mov    $0x40336e,%edx
  401d97:	be f0 34 40 00       	mov    $0x4034f0,%esi
  ...
  401db2:	be ac 33 40 00       	mov    $0x4033ac,%esi
  ...
  401dcd:	be b9 33 40 00       	mov    $0x4033b9,%esi
  ...
  401de8:	be c5 33 40 00       	mov    $0x4033c5,%esi
  ...
  401e01:	be ce 33 40 00       	mov    $0x4033ce,%esi
...
0000000000401e36 <validate>:
  ...
  401e4a:	bf da 33 40 00       	mov    $0x4033da,%edi
  ...
  401e6a:	be 18 35 40 00       	mov    $0x403518,%esi
  ...
  401e97:	be f8 33 40 00       	mov    $0x4033f8,%esi
  ...
  401eb5:	bf da 33 40 00       	mov    $0x4033da,%edi
  ...
  401ed6:	be 40 35 40 00       	mov    $0x403540,%esi
...
0000000000401f20 <bushandler>:
  ...
  401f2d:	bf 0d 34 40 00       	mov    $0x40340d,%edi
  ...
  401f41:	bf 78 35 40 00       	mov    $0x403578,%edi
  401f46:	e8 95 ed ff ff       	callq  400ce0 <puts@plt>
  401f4b:	bf 17 34 40 00       	mov    $0x403417,%edi
...
0000000000401f6e <seghandler>:
  ...
  401f7b:	bf 2d 34 40 00       	mov    $0x40342d,%edi
  ...
  401f8f:	bf 98 35 40 00       	mov    $0x403598,%edi
  401f94:	e8 47 ed ff ff       	callq  400ce0 <puts@plt>
  401f99:	bf 17 34 40 00       	mov    $0x403417,%edi
...
0000000000401fbc <illegalhandler>:
  ...
  401fc9:	bf 40 34 40 00       	mov    $0x403440,%edi
  ...
  401fdd:	bf c0 35 40 00       	mov    $0x4035c0,%edi
  401fe2:	e8 f9 ec ff ff       	callq  400ce0 <puts@plt>
  401fe7:	bf 17 34 40 00       	mov    $0x403417,%edi
...
000000000040200a <sigalrmhandler>:
  ...
  402017:	bf 54 34 40 00       	mov    $0x403454,%edi
  ...
  402030:	be f0 35 40 00       	mov    $0x4035f0,%esi
...
000000000040205d <launch>:
  ...
  4020a5:	be 5c 34 40 00       	mov    $0x40345c,%esi
  ...
  4020ea:	bf 74 34 40 00       	mov    $0x403474,%edi
...
000000000040210a <stable_launch>:
  ...
  402154:	ba 28 36 40 00       	mov    $0x403628,%edx
...
00000000004021d2 <sigalrm_handler>:
  ...
  4021db:	ba 60 36 40 00       	mov    $0x403660,%edx
...
0000000000402367 <urlencode>:
  ...
  402405:	b9 f8 36 40 00       	mov    $0x4036f8,%ecx
...
0000000000402474 <submitr>:
  ...
  4027d5:	b9 88 36 40 00       	mov    $0x403688,%ecx
  ...
  402948:	00 
  402949:	be ff 36 40 00       	mov    $0x4036ff,%esi
  ...
  402ae6:	00 
  402ae7:	b9 c8 36 40 00       	mov    $0x4036c8,%ecx
  ...
  402b5e:	bf 10 37 40 00       	mov    $0x403710,%edi
...
0000000000402bfb <init_driver>:
  ...
  402caa:	bf 15 37 40 00       	mov    $0x403715,%edi
  ...
  402d52:	66 c7 44 24 02 12 f9 	movw   $0xf912,0x2(%rsp)
...
0000000000402dee <driver_post>:
  ...
  402dfe:	be 2a 37 40 00       	mov    $0x40372a,%esi
  ...
  402e3c:	be f9 12 00 00       	mov    $0x12f9,%esi
  402e41:	bf 15 37 40 00       	mov    $0x403715,%edi
